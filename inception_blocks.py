...
def inception_block_1a(X):
    ...
    # CONCAT
    # print(X_3x3.shape, X_5x5.shape, X_pool.shape, X_1x1.shape)
...
def artMaterialVeriModel(input_shape):
    """
    ...
    model = Model(inputs = X_input, outputs = X, name='ArtMaterialVeriModel')
